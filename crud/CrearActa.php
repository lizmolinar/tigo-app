        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" method="POST">
          ...
          <form id="formularion" onsubmit="return validarCheckbox()">
            <tr colspan="1">
              ...
              <td><b><input class="imput_in" type="text" name="disco_n"  onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required></b>
              </tr>
              <tr>
              <td><b> S/N: </b></td>
              <td><b><input class="imput_in" type="text" name="serial_n"  onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required ></b>
              <td><b>Modelo: </b>
              <td><b><input class="imput_in" type="text" name="modelo_n"  onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required></b>
              <td><b>Memoria RAM: </b>
              <td><b><input class="imput_in" type="text" name="memoria_n" onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required></b>
              </tr>
              <tr>
              <td><b> Nombre de Maquina: </b></td>
              <td><b><input class="imput_in" type="text" name="nombre_equipo_n"  onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required></b>
              <td><b>MAC: </b>
              <td><b><input class="imput_in" ty pe="text" name="mac_n" onkeypress="return (event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 48 && event.charCode <= 57 || (event.charCode === 32) || (event.charCode === 35) || (event.charCode === 45) || (event.charCode === 46) || (event.charCode === 44))" maxlength="60" autocomplete="off" required ></b>
              <td><b>Dirección IP: </b>
